...
class URL:
    ...
    urls = {
        ...
        'rankings': 'https://feeds.datagolf.com/preds/get-dg-rankings?file_format={file_format}&key=6a626b6c312c0d33cfe157d614b5'
    }
    ...
    @classmethod
    @cache
    def datagolf_rankings(cls, file_format):
        url = cls.urls['rankings'].format(file_format=file_format)
